...
<div class="gradient-bg1 bg-overlay opacity-8 z-index-1 slider-dark"></div>
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          style="z-index: 6; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 500; color: #ffffff; letter-spacing: 0px;font-family:Raleway, sans-serif">
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          style="z-index: 7; white-space: nowrap; font-size: 40px; line-height: 50px; font-weight: 200; color: #ffffff; letter-spacing: 0px;font-family:Raleway, sans-serif;"><?php echo nl2br($slider['text_03']); ?>
     </div>
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          <a class="white clr-b hvr-shutter-out-horizontal-blk btn 
          btn-large btn-rounded scroll" href="<?php echo $slider['btn_url']; ?>">
