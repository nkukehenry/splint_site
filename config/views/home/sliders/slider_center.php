<li data-index="rs-2" data-transition="crossfade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-thumb="<?php echo base_url(); ?>public/uploads/slider/<?php echo $slider['photo']; ?>"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
     ...
     <!-- MAIN IMAGE -->sliders
     <img src="<?php echo base_url(); ?>public/uploads/slider/<?php echo $slider['photo']; ?>"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
     <!-- LAYERS -->
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          data-y="['middle','middle','middle','middle']" data-voffset="['-77','-77','-77','-90']"
          ...
          style="z-index: 5; white-space: nowrap; font-size: 30px; line-height: 35px; font-weight: 600; color: #ffffff; letter-spacing: 0px;font-family:Raleway, sans-serif; text-transform: capitalize">
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          data-y="['middle','middle','middle','middle']" data-voffset="['0','7','7','-38']"
          data-fontsize="['80','50','20','14']"
          data-width="none"
          data-height="none"
          data-whitespace="nowrap"
          ...
          style="z-index: 6; white-space: nowrap; font-size: 70px; line-height: 80px; font-weight: 600; color: #ffffff; letter-spacing: 4px;font-family:Raleway, sans-serif; text-transform: capitalize">
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          data-y="['middle','middle','middle','middle']" data-voffset="['81','81','83','12']"
          ...
          style="z-index: 7; min-width: 500px; max-width: 500px; white-space: normal; font-size: 18px; line-height: 22px; font-weight: 300; color: #ffffff; letter-spacing: 1px;font-family:Roboto;">
          <?php echo nl2br($slider['text_03']); ?>
     </div>
     ...
     <div class="tp-caption   tp-resizeme"
          ...
          <a class="white clr-b hvr-shutter-out-horizontal-blk btn btn-large btn-rounded scroll" href="<?php echo $slider['btn_url']; ?>"><?php echo nl2br($slider['btn_text']); ?></a>
     </div>
     <?php } ?>
 </li>
