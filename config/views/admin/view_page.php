        ...
        <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab_5" data-toggle="tab">Jobs & Opportunities</a></li>
                       <!--  <li><a href="#tab_7" data-toggle="tab">Testimonial</a></li> -->
                        <li><a href="#tab_8" data-toggle="tab">Blog</a></li> 
                        <li><a href="#tab_16" data-toggle="tab">Programs & Events</a></li>
                        <li><a href="#tab_14" data-toggle="tab">Team</a></li>
                        <li><a href="#tab_9" data-toggle="tab">Contact</a></li>
                        <li><a href="#tab_15" data-toggle="tab">Community & Membership</a></li>
                        ...
                        <div class="tab-pane active" id="tab_1">
                            ...
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title (middle text - emphasis)</label>
                                    <div class="col-sm-3">
                                        <input type="text" name="about_txt_1" class="form-control" value="<?php echo $page_home['about_txt_1']; ?>">
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" name="about_txt_2" class="form-control" value="<?php echo $page_home['about_txt_2']; ?>">
                                    </div>
                                    <div class="col-sm-3">
                                        <input type="text" name="about_txt_3" class="form-control" value="<?php echo $page_home['about_txt_3']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Body </label>
                                    <div class="col-sm-9">
                                        <textarea name="about_body" class="form-control " cols="30" rows="4"><?php echo $page_home['about_body']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Highlight 1</label>
                                    <div class="col-sm-9">
                                        <textarea name="highlight_1" class="form-control " cols="30" rows="2"><?php echo $page_home['highlight_1']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Highlight 2</label>
                                    <div class="col-sm-9">
                                        <textarea name="highlight_2" class="form-control " cols="30" rows="2"><?php echo $page_home['highlight_2']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9" style="padding-top:6px;">
                                        <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_home['home_about_photo']; ?>" class="existing-photo" style="height:180px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-success pull-left" name="about_section_home">Update</button>
                                    </div>
                                </div>
                            <?php echo form_close(); ?>

                            
                            <h3 class="sec_title">Counter Section & Video Section PT 1</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <input type="hidden" name="home_welcome_pbar4_value" class="form-control" value="<?php echo $page_home['home_welcome_pbar4_value']; ?>">
                                <input type="hidden" name="home_welcome_pbar3_text" class="form-control" value="<?php echo $page_home['home_welcome_pbar3_text']; ?>">
                                <input type="hidden" name="home_welcome_pbar3_value" class="form-control" value="<?php echo $page_home['home_welcome_pbar3_value']; ?>">

                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Text </label>
                                    <div class="col-sm-9">
                                        <textarea name="home_welcome_text" class="form-control " cols="30" rows="4"><?php echo $page_home['home_welcome_text']; ?></textarea>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title 1 - Text </label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title 2 - Text </label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title 3 - Text </label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Title 4 - Text </label>
                                    <div class="col-sm-5">
                                ...
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Text </label>
                                    <div class="col-sm-9">
                                        <textarea name="home_welcome_subtitle" class="form-control" cols="30" rows="4" style="height:100px;"><?php echo $page_home['home_welcome_subtitle']; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="home_welcome_video" class="form-control" cols="30" rows="6" style="height:100px;"><?php echo $page_home['home_welcome_video']; ?></textarea>
                                    </div>
                                </div>
                            ...
                            <h3 class="sec_title">Video Section PT 2 (Caption)</h3>
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                            ...
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="meta_description" style="height:100px;"><?php echo $page_home['meta_description']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2"></label>
...
*/ ?>
                        ...
                        <div class="tab-pane" id="tab_2">
                            <?php echo form_open_multipart(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-1 control-label">About Heading </label>
                                    <div class="col-sm-11">
                                        <input type="text" name="about_heading" class="form-control" value="<?php echo $page_about['about_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group" >
                                    <label for="" class="col-sm-1 control-label">About Content </label>
                                    <div class="col-sm-11">
                                        <textarea name="about_content" class="form-control editor" cols="30" rows="4"><?php echo $page_about['about_content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-1 control-label">Existing Photo</label>
                                    <div class="col-sm-11" style="padding-top:6px;">
                                        <img src="<?php echo base_url(); ?>public/uploads/<?php echo $page_about['image']; ?>" class="existing-photo" style="height:180px;">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-1 control-label">Photo </label>
                                    <div class="col-sm-11">
                                        <input type="file" name="image" value="<?php echo $page_about['image']; ?>" class="form-control" >
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="col-sm-6">
                                        <div><center>Mission</center></div>
                                        <textarea name="mission" class="form-control editor" cols="30" rows="4"><?php echo $page_about['mission']; ?></textarea>
                                    </div>
                                    <div class="col-sm-6">
                                        <div><center>Vision</center></div>
                                        <textarea name="vision" class="form-control editor" cols="30" rows="3"><?php echo $page_about['vision']; ?></textarea>
                                    </div>
                                    
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="col-sm-12"><b>GOALS</b></div>
                                    <div class="col-sm-4" style="background-color:#d3cbcb33;">
                                        <input type="text" name="goal_title1" placeholder="Goal Title 1" class="form-control" value="<?php echo $page_about['goal_title1']; ?>"><br>
                                        <textarea name="goal_value1" placeholder="Goal Value 1" class="form-control editor" cols="30" rows="4"><?php echo $page_about['goal_value1']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4" style="background-color:#ffff;">
                                        <input type="text" placeholder="Goal Title 2" name="goal_title2" class="form-control" value="<?php echo $page_about['goal_title2']; ?>"><br>
                                        <textarea name="goal_value2" placeholder="Goal Value 2" class="form-control editor" cols="30" rows="4"><?php echo $page_about['goal_value2']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4" style="background-color:#d3cbcb33;">
                                        <input type="text" placeholder="Goal Title 3" name="goal_title3" class="form-control" value="<?php echo $page_about['goal_title3']; ?>"><br>
                                        <textarea name="goal_value3" placeholder="Goal Value 3" class="form-control editor" cols="30" rows="4"><?php echo $page_about['goal_value3']; ?></textarea>
                                    </div>
                                </div>

                                <hr>
                                <div class="form-group">
                                    <div class="col-sm-12"><b>FITSPA's Objectives</b></div>
                                    <div class="col-sm-4" style="background-color:#d3cbcb33;">
                                        <input type="text" placeholder="Objective Title 1" name="obj_title1" class="form-control" value="<?php echo $page_about['obj_title1']; ?>"><br>
                                        <textarea name="obj_value1" class="form-control" placeholder="Objective Value 1" cols="30" rows="4"><?php echo $page_about['obj_value1']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4">
                                        <input type="text" placeholder="Objective Title 2" name="obj_title2" class="form-control" value="<?php echo $page_about['obj_title2']; ?>"><br>
                                        <textarea name="obj_value2" class="form-control" placeholder="Objective Value 2" cols="30" rows="4"><?php echo $page_about['obj_value2']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4" style="background-color:#d3cbcb33;">
                                        <input type="text" placeholder="Objective Title 3" name="obj_title3" class="form-control" value="<?php echo $page_about['obj_title3']; ?>"><br>
                                        <textarea name="obj_value3" placeholder="Objective Value 3" class="form-control" cols="30" rows="4"><?php echo $page_about['obj_value3']; ?></textarea>
                                    </div>

                                    <div class="col-sm-4"><br>
                                        <input type="text" name="obj_title4" placeholder="Objective Title 4" class="form-control" value="<?php echo $page_about['obj_title4']; ?>"><br>
                                        <textarea name="obj_value4" placeholder="Objective Value 5" class="form-control" cols="30" rows="4"><?php echo $page_about['obj_value4']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4" style="background-color:#d3cbcb33;"><br>
                                        <input type="text" placeholder="Objective Title 5" name="obj_title5" class="form-control" value="<?php echo $page_about['obj_title5']; ?>"><br>
                                        <textarea name="obj_value5" placeholder="Objective Value 5" class="form-control" cols="30" rows="4"><?php echo $page_about['obj_value5']; ?></textarea>
                                    </div>
                                    <div class="col-sm-4"><br>
                                        <input type="text" name="obj_title6" placeholder="Objective Title 6" class="form-control" value="<?php echo $page_about['obj_title6']; ?>"><br>
                                        <textarea name="obj_value6" placeholder="Objective Value 6" class="form-control" cols="30" rows="4"><?php echo $page_about['obj_value6']; ?></textarea>
                                    </div>
                                </div>
                        ...
                        <div class="tab-pane" id="tab_5">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Jobs Heading </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="service_heading" class="form-control" value="<?php echo $page_service['service_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Opportunities Heading </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="opportunity_heading" class="form-control" value="<?php echo $page_service['opportunity_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Title </label>
                        ...
                        <div class="tab-pane" id="tab_15">
                            <?php echo form_open(base_url().'admin/page/update',array('class' => 'form-horizontal')); ?>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Community & Membership Heading </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="community_heading" class="form-control" value="<?php echo $page_community['community_heading']; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Title </label>
                                    <div class="col-sm-9">
                                        <input type="text" name="mt_portfolio" class="form-control" value="<?php echo $page_community['mt_portfolio']; ?>">
                                    </div>
                                </div>      
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Keyword </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="mk_portfolio" style="height:60px;"><?php echo $page_community['mk_portfolio']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label">Meta Description </label>
                                    <div class="col-sm-9">
                                        <textarea class="form-control" name="md_portfolio" style="height:60px;"><?php echo $page_community['md_portfolio']; ?></textarea>
                                    </div>
                                </div>  
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"></label>
                                    <div class="col-sm-9">
                                        <button type="submit" class="btn btn-success pull-left" name="form_community">Update</button>
                                    </div>
                                </div>                              
                            <?php echo form_close(); ?>
                        </div>
