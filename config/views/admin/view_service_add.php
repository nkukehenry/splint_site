...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Jobs and Opputunities</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/jobs-and-opportunities" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/jobs-and-opportunities/new',array('class' => 'form-horizontal')); ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<select type="text" class="form-control" name="category" required="">
									...
									<option value="Job Opennings">Job Opennings</option>
