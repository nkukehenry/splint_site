...
<div class="banner-slider" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $setting['banner_service']; ?>)">
    ...
    <div class="bannder-table">
        <div class="banner-text wow fadeInUp">
            <h1><?php echo $page_service['opportunity_heading']; ?></h1>
        </div>
    </div>
</div>
<!--Banner End-->
            ...
            foreach ($opportunities as $row) {
                ...
                <div class="col-lg-4 col-md-6 wow fadeInDown">
                    <div class="services-item effect-item">
                        <a href="<?php echo base_url(); ?>opportunities/<?php echo $row['name_slag']; ?>" class="image-effect">
                            <div class="services-photo" style="background-image: url(<?php echo base_url(); ?>public/uploads/<?php echo $row['photo']; ?>)"></div>
                        </a>
                        <div class="services-text">
                            <h3><a href="<?php echo base_url(); ?>opportunities/<?php echo $row['name_slag']; ?>"><?php echo $row['name']; ?></a></h3>
                            <p>
                                <?php echo nl2br(character_limiter($row['short_description'],300)); ?>
                            </p>
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>opportunities/<?php echo $row['name_slag']; ?>"><?php echo READ_MORE; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
