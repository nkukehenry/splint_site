        ...
        <div class="row">
            <div class="col-lg-8">               
                ...
                foreach($news_fetched as $row) {
                    ?>
                    <div class="blog-one-item wow fadeInDown">
                        ...
                        <div class="blog-one-text">
                            <ul>
                                <li><i class="fa fa-edit"></i><a href="<?php echo base_url(); ?>blog-post/category/<?php echo $row->title_slag; ?>"><?php echo $row->category_name; ?></a></li>
