                        ...
                        <div class="<?php if($slider['position'] == 'Left') {echo 'col-lg-6 col-md-9 col-12';} else {echo 'offset-lg-6 col-lg-6 offset-md-3 col-md-9 col-12';} ?>">
                            <div class="slider-text">
                                ...
                                <div class="text-animated">
                                 ...
                                 <center><h2 style="color:green;"><?php
                                ...
                                <div class="text-animated">
                                    <ul>                                        
                                        ...
                                        <li><a href="<?php echo $slider['button1_url']; ?>" target="_blank"><?php echo $slider['button1_text']; ?></a></li>
                                        <?php endif; ?>
...
<div class="about-area pt_60" data-aos="fade-up">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mt_30">
                <div class="about-content">
                    <div class="headline-left  text-animated" data-aos="zoom-in-right" data-aos-duration="500">
                        <h2>
        ...
        <div class="col-lg-4 mt_30 mb_30 flexer">
                ...
                <div class="magic-circle smaller flexer"  
                            data-aos="fade-up"
                            data-aos-easing="linear"
                            data-aos-duration="500">

                            <h3 class="text-white">JOIN NOW</h3>
                            <small>The safer side!</small>
...
<div class="choose-area " data-aos="zoom-in" style="background-color: #dcebfa; padding-top:30px; padding-bottom:30px;">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
            ...
            foreach ($why_choose as $row) {
                ...
                <div class="col-lg-4" data-aos="zoom-in" >
                    <div  class="choose-item flex" >
                        <div class="choose-icon magic-circle circular" data-aos="fade-up"
                            data-aos-easing="linear"
...
<div class="services-area pt_90 pb_90" style="background-color: #b5e0ff; ">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
            ...
            foreach ($services as $row) {
                ...
                data-aos-duration="400">
                    <div class="services-item effect-item">
                        ...
                        <div class="services-text" data-aos="fade-up">
            ...
            <div class="col-lg-6">
                <div class="booking-gallery">
                    ...
                    <div class="booking-form pt_30">
                        <form action="<?php echo base_url(); ?>home/newLoan" method="post">
                            <div class="form-row row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" name="phone" class="form-control" placeholder="<?php echo PHONE_NUMBER; ?>" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="email" class="form-control" placeholder="<?php echo EMAIL_ADDRESS; ?>">
                                </div>
                                <div class="form-group col-12">
                                    <input type="number" class="form-control" placeholder="AMOUNT" name="amount" required>
                                </div>
                                <div class="form-group col-12">
                                    <input type="text" name="address" class="form-control" placeholder="<?php echo ADDRESS; ?>" required>
                                </div>
                                <div class="form-group col-12">
...
<!--Brand-Area Start-->
<div class="brand-area bg-area pt_10 pb_10">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="brand-carousel owl-carousel">
                    ...
                    foreach($clients as $row) {
                        ?>
                        <?php if($row['url']!=''): ?>
                            <div class="brand-item"><a href="<?php echo $row['url']; ?>"><img src="<?php echo base_url(); ?>public/uploads/partners/<?php echo $row['photo']; ?>" alt="<?php echo $row['name']; ?>"></a></div>
                        <?php else: ?>
                            <div class="brand-item"><img src="<?php echo base_url(); ?>public/uploads/partners/<?php echo $row['photo']; ?>" alt="<?php echo $row['name']; ?>"></div>
                        <?php endif; ?>
                        <?php
                    }
                    ?>
