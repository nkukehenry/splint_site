...
class Dashboard extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['careers_jobs'] = $this->Model_dashboard->all_service();
		$data['opportunities'] = $this->Model_dashboard->all_opportunities();
		$data['community'] = $this->Model_dashboard->all_community();
