...
class Page extends CI_Controller 
{
	...
	public function index()
	{
		...
		$data['page_community'] = $this->Model_page->show_community();
	...
	public function update()
	{
		...
		if(isset($_POST['about_section_home'])) {
		    ...
		    if($path!='') {
		        ...
		        if($ext_check == FALSE) {
    		    	...
    		    	// removing the existing photo
    		    	unlink('./public/uploads/'.$data['page']['home_about_photo']);
    
    		    	// updating the data
    		    	$final_name = 'home-about'.'.'.$ext;
    				...
    				$form_data = array(
    					...
    					'about_txt_1'   => $_POST['about_txt_1'],
    					'about_txt_2'   => $_POST['about_txt_2'],
    					'about_txt_3'   => $_POST['about_txt_3'],
    	        	...
    	        	$success = 'Home page about data is updated successfully!';
    		    	$this->session->set_flashdata('success',$success);
    		    	redirect(base_url().'admin/page');
		...
		if(isset($_POST['form_about'])) {
		    ...
		    if($path!='') {
		    	...
		    	// removing the existing photo
		    	unlink('./public/uploads/'.$data['page']['image']);

		    	// updating the data
		    	$final_name = 'about-us-pg'.'.'.$ext;
		        $destination = './public/uploads/'.$final_name;
        	...
        	$form_data = array(
				...
				'vision' => $_POST['vision'],
				'goal_title1' => $_POST['goal_title1'],
				'goal_value1' => $_POST['goal_value1'],
				'goal_title2' => $_POST['goal_title2'],
				'goal_value2' => $_POST['goal_value2'],
				'goal_title3' => $_POST['goal_title3'],
				'goal_value3' => $_POST['goal_value3'],
				'obj_title1' => $_POST['obj_title1'],
				'obj_value1' => $_POST['obj_value1'],
				'obj_title2' => $_POST['obj_title2'],
				'obj_value2' => $_POST['obj_value2'],
				'obj_title3' => $_POST['obj_title3'],
				'obj_value3' => $_POST['obj_value3'],
				'obj_title4' => $_POST['obj_title4'],
				'obj_value4' => $_POST['obj_value4'],
				'obj_title5' => $_POST['obj_title5'],
				'obj_value5' => $_POST['obj_value5'],
				'obj_title6' => $_POST['obj_title6'],
				'obj_value6' => $_POST['obj_value6'],
		...
		if(isset($_POST['form_service'])) {
        	$form_data = array(
        		'opportunity_heading' => $_POST['opportunity_heading'],
		...
		if(isset($_POST['form_community'])) {
        	$form_data = array(
				'community_heading' => $_POST['community_heading'],
				'mt_portfolio'      => $_POST['mt_portfolio'],
				'mk_portfolio'      => $_POST['mk_portfolio'],
				'md_portfolio'      => $_POST['md_portfolio']
            );
        	$this->Model_page->update_community($form_data);
        	$success = 'Community & Membership Page Setting is updated successfully!';
        	$this->session->set_flashdata('success',$success);
		    redirect(base_url().'admin/page');
		}
