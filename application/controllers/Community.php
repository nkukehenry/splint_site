...
class Community extends CI_Controller {
		...
		if($captcha_response != '')
		{
			...
			if($finalResponse['success'])
			{
        	    ...
        	    if (isset($_POST['form_register'])) {
						...
						$this->alertAdmin($_POST['email']);

        		        $success = 'Registration is submitted successfully!';
	...
	public  function alertAdmin($email)
	{
		$data['row'] = $this->Model_community->get_subscriber($email);
		$message = $this->load->view('emails/subscriber_email',$data,true);
		@send_mail('info@fitspa.ug',$message,'New member Subscription Request');
	}
