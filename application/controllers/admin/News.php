	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
		        ...
		        $destination1 = './public/uploads/'.$final_name1;
				
				move_uploaded_file($path_tmp1, $destination1);

				if ($ext!=="webp") {
				 $webp_image = $this->towebp->convert($destination1,100,true);
				 if($webp_image->status==1)
		    	...
		    	$dt = strtolower(str_replace(" - "," ",$_POST['news_title']));
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
				...
				if($path == '' && $path1 != '') {
		        	...
		        	$destination = './public/uploads/'.$final_name1;
				
					move_uploaded_file($path_tmp1, $destination);
