...
class Feature extends CI_Controller 
{
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
		        ...
		        $success = 'Encouragining Statement is added successfully!';
		        $this->session->set_flashdata('success',$success);
				redirect(base_url().'admin/encouragement');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'admin/encouragement/add');
		    }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    if($valid == 1) 
		    {
				...
				$success = 'Encouragining Statement is updated successfully';
				$this->session->set_flashdata('success',$success);
				redirect(base_url().'admin/encouragement');
		    }
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().'admin/encouragement/edit/'.$id);
		    }
	...
	public function delete($id) 
	{
        ...
        $success = 'Encouragining Statement is deleted successfully';
        $this->session->set_flashdata('success',$success);
        redirect(base_url().'admin/encouragement');
    }
