			...
			<?php echo form_open_multipart(base_url().'admin/event/edit/'.$event['event_id'],array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Event Category <span>*</span></label>
							<div class="col-sm-10">

								<select class="form-control" name="category">
									<?php 
									foreach($categories as $category):
										$selected = ($event['category_id']==$category->id)?'selected':'';
									?>
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Event Map</label>
							<div class="col-sm-10">
