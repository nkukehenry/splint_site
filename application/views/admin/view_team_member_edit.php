			...
			<?php echo form_open_multipart(base_url().'admin/team_member/edit/'.$team_member['id'],array('class' => 'form-horizontal')); ?>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Committe <span>*</span></label>
							<div class="col-sm-9">
								<select type="text" autocomplete="off" class="form-control" name="com_id">
									<option disabled>Select Committee</option>

									<?php foreach ($committees as $row) { ?>
										<option <?php echo ($row['com_id'] == $team_member['com_id'])?'selected':''; ?>  value="<?php echo $row['com_id']; ?>"><?php echo $row['category_name']; ?></option>
									<?php } ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-9" style="padding-top:5px">
								<img src="<?php echo base_url();; ?>public/uploads/team/<?php echo $team_member['photo']; ?>" alt="Team Member Photo" style="width:200px;">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Photo <span>*</span></label>
							<div class="col-sm-9" style="padding-top:5px">
								<input type="file" name="photo">(Only jpg, jpeg, gif, png, svg and webp are allowed)
							</div>
						</div>
						<div class="form-group">
