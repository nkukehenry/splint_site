...
<section class="content-header">
	<div class="content-header-left">
		<h1>Edit Jobs and  Opputunities</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/jobs-and-opportunities/new" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/jobs-and-opportunities/edit/'.$service['id'],array('class' => 'form-horizontal'));?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<select type="text" class="form-control" name="category" required="">
									...
									<option value="Job Opennings"  <?php if($service['category']=="Job Opennings"){ echo "selected";}else{ echo "";} ?>>Job Opennings</option>
									<option value="Opportunities" <?php if($service['category']=="Opportunities"){ echo "selected";}else{ echo "";} ?>>Opportunities</option>
								</select>
							</div>
						</div>
