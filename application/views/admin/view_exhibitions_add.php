...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Member Exhibitions</h1>
	</div>
	<div class="content-header-right">
		<a href="<?php echo base_url(); ?>admin/exhibitions" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().'admin/exhibitions/new',array('class' => 'form-horizontal')); ?>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								...
								<select type="text" class="form-control select2" name="member_id">
									...
									<option value="<?php echo $row['id']; ?>"><?php echo $row['name']; ?> <img width="110px" src="<?php echo base_url(); ?>public/uploads/comnty-member/<?php echo $row['photo']; ?>"></option>
									<?php } ?>
