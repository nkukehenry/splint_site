				...
				<div class="nav-tabs-custom">
					...
					<div class="tab-content">
          				...
          				<div class="tab-pane" id="tab_footer">
							...
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Column 3 Title (Address) </label>
								<div class="col-sm-6">
									<input class="form-control" type="text" name="footer_col3_title" value="<?php echo $setting['footer_col3_title']; ?>">
								</div>
							</div>
							<div class="form-group hide">
								<label for="" class="col-sm-3 control-label">Column 1 Text  </label>
								<div class="col-sm-6">
									<textarea class="form-control" name="footer_col4_title" style="height:70px;"><?php echo $setting['footer_col4_title']; ?></textarea>
								</div>
							</div>
							<div class="form-group">
