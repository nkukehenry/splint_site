	...
	<script type="text/javascript">
        ...
        $(document).ready(function () {
		    ...
		    $("#btnAddNew").click(function () {
		        ...
		        var addLink = "<div class=\"upload-btn" + rowNumber + "\"><input type=\"file\" name=\"photos[]\" class=\"form-control\">  <input type=\"text\" name=\"name[]\"> <textarea type=\"text\" class=\"form-control\" name=\"description[]\"></textarea></div>";
