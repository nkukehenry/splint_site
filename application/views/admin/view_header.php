	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="<?php echo base_url(); ?>admin/dashboard" class="logo">
				<span class="logo-lg">SPLINT</span>
			</a>
  		...
  		<aside class="main-sidebar">
    		<section class="sidebar">
      			...
      			<ul class="sidebar-menu">
			        ...
			        <li class="treeview <?php if( ($class_name == 'setting') ) {echo 'active';} ?>">
			         ...
			         <li class="treeview <?php if( ($class_name == 'page') ) {echo 'active';} ?>">
			          <a href="<?php echo base_url(); ?>admin/page">
			            <i class="fa fa-picture-o"></i> <span>Page Configs</span>
			          </a>
			        </li>
			        ...
			        <li class="treeview <?php if( ($class_name == 'pages') ) {echo 'active';} ?>">
