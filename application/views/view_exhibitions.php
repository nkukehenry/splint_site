            ...
            foreach ($exhibitions as $row) {
                ...
                <div class="col-lg-4 col-md-6 wow fadeInDown">
                    <div class="services-item effect-item">
                        <a href="<?php echo base_url(); ?>member_blogs/<?php echo $row['name_slag']; ?>" class="image-effect">
                        ...
                        <div class="services-text">
                            <h3><a href="<?php echo base_url(); ?>member_blogs/<?php echo $row['name_slag']; ?>"><?php echo $row['name']; ?></a></h3>
                            <p>
                            ...
                            <div class="button-bn">
                                <a href="<?php echo base_url(); ?>member_blogs/<?php echo $row['name_slag']; ?>"><?php echo READ_MORE; ?> <i class="fa fa-chevron-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
