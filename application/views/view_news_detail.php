        ...
        <div class="row  sidebar-item">
            <div class="col-lg-8">
                <div class="single-blog">
                    <img class="col-md-12" src="<?php echo base_url(); ?>public/uploads/<?php echo $news_detail['photo']; ?>" alt="News Photo"/>
                    
                    <h3><?php echo $news_detail['news_title']; ?></h3>
                    <ul>
                        <li><i class="fa fa-edit"></i><a href="<?php echo base_url(); ?>blog-post/category/<?php echo $news_detail['title_slag']; ?>"><?php echo $news_detail['category_name']; ?></a></li>
